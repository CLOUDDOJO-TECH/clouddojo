  ...
  return (
    <div className="relative w-full">
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 h-1/3 bg-linear-to-b from-white/40 dark:from-white/5 to-transparent rounded-t-2xl opacity-50" />
      ...
      <div className="absolute inset-0 bg-linear-to-br from-emerald-500/5 via-blue-500/5 to-purple-500/5 dark:from-emerald-500/10 dark:via-blue-500/5 dark:to-purple-500/5 rounded-2xl blur-3xl -z-10 scale-110" />
    </div>
  );
}
