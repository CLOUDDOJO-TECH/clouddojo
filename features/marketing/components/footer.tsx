      ...
      <div className="container mx-auto">
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex space-x-4">
            <a
              href="/privacy"
              className="text-xs text-gray-500 hover:text-teal"
            >
              Privacy Policy
            </a>
            <a href="/tos" className="text-xs text-gray-500 hover:text-teal">
              Terms of Service
            </a>
            <a
              href="/contact"
            ...
            <a href="/blog" className="text-xs text-gray-500 hover:text-teal">
              Blog
            </a>
          </div>
        </div>
