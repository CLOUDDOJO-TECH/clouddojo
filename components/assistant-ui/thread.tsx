  ...
  return (
    <ThreadPrimitive.Empty>
      <div className="flex w-full max-w-(--thread-max-width) grow flex-col">
        ...
        <h2 className="relative flex-col md:flex-row z-10 text-3xl md:text-5xl md:leading-tight max-w-5xl mx-auto text-center tracking-tight font-medium bg-clip-text text-transparent bg-linear-to-b from-white/60 dark:from-neutral-800 dark:via-white via-neutral-600 via- dark:to-white to-neutral-800 flex items-center gap-2 md:gap-8">
  ...
  return (
    <ComposerPrimitive.Root className="focus-within:border-ring/20 flex w-full flex-wrap items-end rounded-lg border bg-background px-2.5 shadow-sm transition-colors ease-in">
      <ComposerPrimitive.Input
        ...
        className="placeholder:text-muted-foreground max-h-[300px] grow resize-none border-none bg-background px-2 py-4 text-sm outline-none focus:ring-0 disabled:cursor-not-allowed"
      />
      <ComposerAction />
...
const UserMessage: FC = () => {
  return (
    <MessagePrimitive.Root className="grid auto-rows-auto grid-cols-[minmax(72px,1fr)_auto] gap-y-2 [&:where(>*)]:col-start-2 w-full max-w-(--thread-max-width) py-4">
      <UserActionBar />

      <div className="bg-muted text-foreground max-w-[calc(var(--thread-max-width)*0.8)] wrap-break-word rounded-3xl px-5 py-2.5 col-start-2 row-start-2">
...
const EditComposer: FC = () => {
  return (
    <ComposerPrimitive.Root className="bg-muted my-4 flex w-full max-w-(--thread-max-width) flex-col items-center gap-2 rounded-xl">
...
const AssistantMessage: FC = () => {
  return (
    <MessagePrimitive.Root className="grid grid-cols-[auto_auto_1fr] grid-rows-[auto_1fr] relative w-full max-w-(--thread-max-width) py-4">
      <div className="text-foreground max-w-[calc(var(--thread-max-width)*0.8)] wrap-break-word leading-7 col-span-2 col-start-2 row-start-1 my-1.5">
